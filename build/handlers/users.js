...
var users = new users_1.UserService();
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, userresult;
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, username = _a.username, password = _a.password;
                return [4 /*yield*/, users.login(username, password)];
            case 1:
                result = _b.sent();
                res.json(result);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, users.refreshToken(refreshToken)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [2 /*return*/];
